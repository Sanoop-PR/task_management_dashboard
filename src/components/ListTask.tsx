  ...
  return (
    <div className="text-slate-800 flex w-full items-center rounded-md p-2 pl-3 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100 border">
      <label className="flex items-center cursor-pointer relative mr-2">
        <input type="checkbox" className="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-green-600 checked:border-green-600" id="check4" />
      ...
      <p className="flex-1 outline-none">
        ...
        natus quasi iure, iste excepturi praesentium. Aut tempore excepturi eius
        neque possimus dolorum corrupti est adipisci, quos accusantium non
        blanditiis iste!
      </p>
